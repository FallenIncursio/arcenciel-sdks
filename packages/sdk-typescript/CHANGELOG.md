...
- Added `client.oauth` helpers for PKCE S256, state/issuer callback validation, code exchange, refresh rotation, revocation, and
  confidential introspection; token writes are never automatically retried.
