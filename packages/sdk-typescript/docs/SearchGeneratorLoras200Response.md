...
```typescript
import type { SearchGeneratorLoras200Response } from '@arcenciel/sdk'
...
const example = {
  ...
  "limit": null,
  "query": null,
} satisfies SearchGeneratorLoras200Response
...
const exampleParsed = JSON.parse(exampleJSON) as SearchGeneratorLoras200Response
