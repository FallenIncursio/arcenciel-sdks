...
```typescript
import type { DownloadModelVersion200Response } from '@arcenciel/sdk'

// TODO: Update the object below with actual values
const example = {
  "message": Download registered (external URL),
} satisfies DownloadModelVersion200Response
...
const exampleParsed = JSON.parse(exampleJSON) as DownloadModelVersion200Response
