...
class TestWebhookEndpoint202ResponseData(BaseModel):
    ...
    """ # noqa: E501
    delivery_id: StrictStr = Field(description="Delivery Id accepted or returned by this contract.", alias="deliveryId")
    event_id: StrictStr = Field(description="Event Id accepted or returned by this contract.", alias="eventId")
