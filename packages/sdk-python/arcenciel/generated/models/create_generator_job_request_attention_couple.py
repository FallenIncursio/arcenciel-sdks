...
class CreateGeneratorJobRequestAttentionCouple(BaseModel):
    ...
    regions: Optional[Annotated[List[CreateGeneratorJobRequestAttentionCoupleRegionsInner], Field(max_length=2)]] = Field(default=None, description="Regions accepted or returned by this contract.")
