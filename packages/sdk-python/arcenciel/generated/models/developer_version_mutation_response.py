...
class DeveloperVersionMutationResponse(BaseModel):
    """
    DeveloperVersionMutationResponse
    """ # noqa: E501
    message: StrictStr = Field(json_schema_extra={"examples": ["Version updated successfully"]})
    version: Version
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["message", "version"]
