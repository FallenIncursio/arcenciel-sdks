...
class RotateWebhookSecret200Response(BaseModel):
    ...
    previous_secret_expires_at: datetime = Field(description="Previous Secret Expires At accepted or returned by this contract.", alias="previousSecretExpiresAt")
    secret: StrictStr = Field(description="Secret accepted or returned by this contract.")
