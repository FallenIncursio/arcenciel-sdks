...
class CreateWebhookEndpointRequest(BaseModel):
    ...
    """ # noqa: E501
    event_types: Annotated[List[StrictStr], Field(min_length=1)] = Field(description="Event Types accepted or returned by this contract.", alias="eventTypes")
    name: Annotated[str, Field(strict=True, max_length=100)] = Field(description="Name accepted or returned by this contract.")
