...
class DeveloperVideoReactionResponse(BaseModel):
    """
    DeveloperVideoReactionResponse
    """ # noqa: E501
    message: StrictStr = Field(json_schema_extra={"examples": ["Reaction updated"]})
    video: Optional[Video] = None
    video_id: Optional[StrictInt] = Field(default=None, description="Present when the requested reaction was already active.", alias="videoId", json_schema_extra={"examples": [73]})
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["message", "video", "videoId"]
