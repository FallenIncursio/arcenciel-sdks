...
class CollectionPagination(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["images", "models"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "images": CollectionItemPage.from_dict(obj["images"]) if obj.get("images") is not None else None,
            "models": CollectionItemPage.from_dict(obj["models"]) if obj.get("models") is not None else None
        })
