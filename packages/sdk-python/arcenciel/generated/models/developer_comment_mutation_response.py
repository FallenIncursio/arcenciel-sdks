...
class DeveloperCommentMutationResponse(BaseModel):
    """
    DeveloperCommentMutationResponse
    """ # noqa: E501
    comment: DeveloperComment
    message: StrictStr = Field(json_schema_extra={"examples": ["Comment created"]})
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["comment", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "comment": DeveloperComment.from_dict(obj["comment"]) if obj.get("comment") is not None else None,
