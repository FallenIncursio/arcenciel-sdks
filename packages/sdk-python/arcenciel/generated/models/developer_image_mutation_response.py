...
class DeveloperImageMutationResponse(BaseModel):
    """
    DeveloperImageMutationResponse
    """ # noqa: E501
    image: Image
    message: StrictStr = Field(json_schema_extra={"examples": ["Image updated successfully"]})
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["image", "message"]
