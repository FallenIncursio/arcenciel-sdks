...
class DeveloperNotificationPage(BaseModel):
    """
    DeveloperNotificationPage
    """ # noqa: E501
    data: List[DeveloperNotification]
    has_more: StrictBool = Field(alias="hasMore", json_schema_extra={"examples": [False]})
    ...
    __properties: ClassVar[List[str]] = ["data", "hasMore", "limit", "nextCursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [DeveloperNotification.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
