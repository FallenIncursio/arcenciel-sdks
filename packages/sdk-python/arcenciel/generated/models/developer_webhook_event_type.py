...
class DeveloperWebhookEventType(BaseModel):
    ...
    """ # noqa: E501
    description: StrictStr = Field(description="Description accepted or returned by this contract.")
    type: StrictStr = Field(description="Type accepted or returned by this contract.", json_schema_extra={"examples": ["model.published"]})
    version: StrictStr = Field(description="Version accepted or returned by this contract.", json_schema_extra={"examples": ["1"]})
