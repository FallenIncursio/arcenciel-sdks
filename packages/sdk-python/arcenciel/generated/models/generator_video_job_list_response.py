...
class GeneratorVideoJobListResponse(BaseModel):
    """
    Fields describing generator video job list response in Developer API requests and responses.
    """ # noqa: E501
    jobs: List[GeneratorVideoJob] = Field(description="Ordered jobs entries included with this generator video job list response; an empty list means none are available.")
    next_cursor: Optional[UUID] = Field(description="Cursor for the next page.", alias="nextCursor")
    quota: GeneratorVideoQuota
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["jobs", "nextCursor", "quota"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobs": [GeneratorVideoJob.from_dict(_item) for _item in obj["jobs"]] if obj.get("jobs") is not None else None,
