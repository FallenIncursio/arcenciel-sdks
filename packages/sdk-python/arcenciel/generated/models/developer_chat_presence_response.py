...
class DeveloperChatPresenceResponse(BaseModel):
    """
    DeveloperChatPresenceResponse
    """ # noqa: E501
    data: Dict[str, DeveloperChatPresenceEntry] = Field(description="Presence entries keyed by the requested decimal user identifier.", json_schema_extra={"examples": [{"42": {"lastSeenAt": "2026-08-07T10:00:00.000Z", "online": True}}]})
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": dict(
                (_k, DeveloperChatPresenceEntry.from_dict(_v))
