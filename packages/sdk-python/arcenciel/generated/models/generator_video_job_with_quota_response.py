...
class GeneratorVideoJobWithQuotaResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["job", "quota"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "job": GeneratorVideoJob.from_dict(obj["job"]) if obj.get("job") is not None else None,
