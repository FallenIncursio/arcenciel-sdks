...
class DeveloperArticleMutationResponse(BaseModel):
    """
    DeveloperArticleMutationResponse
    """ # noqa: E501
    article: Article
    message: StrictStr = Field(description="Human-readable confirmation of the completed article mutation; use the HTTP status and article payload for logic.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["article", "message"]
