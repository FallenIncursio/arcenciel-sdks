...
class ReorderCollectionItemsRequest(BaseModel):
    ...
    """ # noqa: E501
    order: List[ReorderCollectionItemsRequestOrderInner] = Field(description="Ordered order entries included with this request payload; an empty list means none are available.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "order": [ReorderCollectionItemsRequestOrderInner.from_dict(_item) for _item in obj["order"]] if obj.get("order") is not None else None
        })
