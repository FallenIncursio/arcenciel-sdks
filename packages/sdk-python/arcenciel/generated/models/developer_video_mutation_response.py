...
class DeveloperVideoMutationResponse(BaseModel):
    """
    DeveloperVideoMutationResponse
    """ # noqa: E501
    message: StrictStr = Field(json_schema_extra={"examples": ["Video updated"]})
    video: Video
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["message", "video"]
