...
class DeveloperChatPresenceEntry(BaseModel):
    """
    DeveloperChatPresenceEntry
    """ # noqa: E501
    last_seen_at: Optional[datetime] = Field(alias="lastSeenAt")
    online: StrictBool = Field(json_schema_extra={"examples": [True]})
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["lastSeenAt", "online"]
