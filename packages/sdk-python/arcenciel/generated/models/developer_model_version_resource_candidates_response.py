...
class DeveloperModelVersionResourceCandidatesResponse(BaseModel):
    """
    DeveloperModelVersionResourceCandidatesResponse
    """ # noqa: E501
    candidates: List[DeveloperModelVersionResourceCandidate]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "candidates": [DeveloperModelVersionResourceCandidate.from_dict(_item) for _item in obj["candidates"]] if obj.get("candidates") is not None else None
        })
