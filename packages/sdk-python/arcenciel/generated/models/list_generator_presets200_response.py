...
class ListGeneratorPresets200Response(BaseModel):
    """
    Fields describing 200 response for api generator presets in Developer API requests and responses.
    """ # noqa: E501
    presets: List[GeneratorPreset] = Field(description="Ordered presets entries included with this 200 response for api generator presets; an empty list means none are available.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["presets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "presets": [GeneratorPreset.from_dict(_item) for _item in obj["presets"]] if obj.get("presets") is not None else None
        })
