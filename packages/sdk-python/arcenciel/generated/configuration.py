...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        ...
        "oauthClientBasicAuth": BasicAuthSetting,
        "sessionCookieAuth": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = arcenciel.generated.Configuration(
...
conf = arcenciel.generated.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://arcenciel.io" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("arcenciel.generated")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        if self.username is not None and self.password is not None:
            auth['oauthClientBasicAuth'] = {
                'type': 'basic',
                'in': 'header',
                'key': 'Authorization',
                'value': self.get_basic_auth_token()
            }
        if 'sessionCookieAuth' in self.api_key:
