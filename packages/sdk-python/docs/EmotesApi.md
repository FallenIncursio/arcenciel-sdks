# arcenciel.generated.EmotesApi

All URIs are relative to *https://arcenciel.io*

Method | HTTP request | Description
------------- | ------------- | -------------
[**list_emotes**](EmotesApi.md#list_emotes) | **GET** /api/emotes | List all emotes


# **list_emotes**
> List[Emote] list_emotes()

**Synchronous variant:** `list_emotes_sync(...)` — same parameters and return type, but blocks until completion instead of requiring `await`.
...
async with arcenciel.generated.ApiClient(configuration) as api_client:
    ...
    api_instance = arcenciel.generated.EmotesApi(api_client)

    try:
        # List all emotes
        api_response = await api_instance.list_emotes()
        print("The response of EmotesApi->list_emotes:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling EmotesApi->list_emotes: %s\n" % e)
```
