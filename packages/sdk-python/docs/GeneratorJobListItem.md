...
**position** | **int** | Queue position hint. | [optional]
...
**queue_eta_ms** | **int** | Estimated queue wait time in milliseconds. | [optional]
...
generator_job_list_item_instance = GeneratorJobListItem.from_json(json)
# print the JSON string representation of the object
print(GeneratorJobListItem.to_json())

# convert the object into a dict
generator_job_list_item_dict = generator_job_list_item_instance.to_dict()
# create an instance of GeneratorJobListItem from a dict
generator_job_list_item_from_dict = GeneratorJobListItem.from_dict(generator_job_list_item_dict)
```
