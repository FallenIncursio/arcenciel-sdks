...
**confidence** | **float** | Numeric confidence reported for this generator adetailer config. Minimum: 0. Maximum: 1. | [optional]
...
**detector** | **str** | Detector associated with this generator adetailer config; preserve server-returned values when passing them to another operation. | [optional]
...
**enabled** | **bool** | Whether enabled applies to this generator adetailer config. | [optional] [default to True]
**iou** | **float** | Numeric iou reported for this generator adetailer config. Minimum: 0. Maximum: 1. | [optional]
...
**max_detections** | **int** | Numeric max detections reported for this generator adetailer config. Minimum: 1. Maximum: 64. | [optional] [default to 2]
**model** | **str** | Model associated with this generator adetailer config; preserve server-returned values when passing them to another operation. | [optional]
**negative_prompt** | **str** | Negative Prompt text associated with generation of this generator adetailer config; availability depends on visibility and privacy rules. | [optional]
