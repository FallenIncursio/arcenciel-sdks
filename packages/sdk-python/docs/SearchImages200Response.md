...
------------ | ------------- | ------------- | -------------
**data** | [**List[Image]**](Image.md) | Data accepted or returned by this contract. | [optional]
...
**showcased** | [**List[Image]**](Image.md) | Showcased accepted or returned by this contract. | [optional]
