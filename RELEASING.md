...
- `api_release`: the immutable contract version, such as `1.10.0`;
- `sdk_version`: the shared package version, such as `1.1.0`; and
- `release_tag`: the signed public tag, such as `sdk-v1.1.0`.
