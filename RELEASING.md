...
- `api_release`: the immutable contract version, such as `1.8.0`;
- `sdk_version`: the shared package version, such as `0.8.0`; and
- `release_tag`: the signed public tag, such as `sdk-v0.8.0`.
